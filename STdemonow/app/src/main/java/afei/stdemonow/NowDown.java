...
public class NowDown {
        ...
        //f=new File(codelist);
            try{
                ...
                if (false) {
                    ...
                    u = new cURLs();
                    u.type = "lhb_c";
                    u.filenamekey = snbk_now + "/"+u.type;
                    u.url1 = "http://www.szse.cn/szseWeb/common/szse/files/text/nmTxt/gk/nm_jy";
                    u.url2 = ".txt";
                    u.encode = "gb2312";
                    u.count = 0;
                    u.timeBegin = 1515;
                    ...
                    u.type = "lhb_zx";
                    u.filenamekey = snbk_now + "/"+u.type;
                    u.url1 = "http://www.szse.cn/szseWeb/common/szse/files/text/smeTxt/gk/sme_jy";
                    u.url2 = ".txt";
                    u.encode = "gb2312";
                    u.count = 0;
                    u.timeBegin = 1515;
                    ...
                    u.type = "lhb_sa";
                    u.filenamekey = snbk_now + "/"+u.type;
                    u.url1 = "http://www.szse.cn/szseWeb/common/szse/files/text/jy/jy";
                    u.url2 = ".txt";
                    u.encode = "gb2312";
                    u.count = 0;
                    u.timeBegin = 1515;
                    ...
                    u.type = "lhb_ha";
                    u.filenamekey = snbk_now + "/"+u.type;
                    u.url1 = "http://query.sse.com.cn/infodisplay/showTradePublicFile.do?jsonCallBack=jsonpCallback&isPagination=false&dateTx=";//dateTx=2018-02-08
                    u.encode = "gb2312";
                    u.count = 0;
                    u.timeBegin = 1515;
                    u.timeEnd = 800;
    ...
    public void start3(){
        ...
        String dir = snbk_now;//workDir + "/snbk_now1";
        f = new File(dir);
