...
public class NowDown3 {
    ...
    private static List<cURLs> listUrlx=new ArrayList<cURLs>();
    ...
    public NowDown3(Context context){
        ...
        cURLs u = new cURLs();
            try{
                 u = new cURLs();
                    u.type = "bknode";
                    u.filenamekey = snbk_now + "/gnbk"+".json";
                    u.codekey = "gn_";
                    u.url1 = sn_url;
                    ...
                    u = new cURLs();
                    u.type = "bknode";
                    u.filenamekey = snbk_now + "/bknode"+".json";
                    u.codekey = "new_";
                    u.url1 = sn_url;
                    u.url2 = "[[\"bknode\",\"\",\"\",0]]";
                    u.url3 = "node";
                    ...
                    u = new cURLs();
                    u.type = "bkshy";
                    u.filenamekey = snbk_now + "/bkshy"+".json";
                    u.codekey = "hangye_";
                    u.url1 = sn_url;
                    u.url2 = "[[\"bkshy\",\"\",0]]";
                    u.url3 = "shy";
                    ...
                    u = new cURLs();
                    u.type = "sse";
                    u.filenamekey = snbk_now+"/sse"+".json";
                    u.url1 = sse_url;
                    u.url = u.url1;
                    u.encode = "gb2312";
                    u.count = 0;
    ...
    public void start2(){
        ...
        LogX.w(TAG,snbk_now + "/files.txt");
        LogX.w(TAG,lines);
        FileX.writeLines(snbk_now + "/files.txt",lines,"utf-8");
        ...
        File fzip=new File(snbk_now+"/AA,"+time+".zip");
        if (!fzip.exists()){
    ...
    class downTask extends Thread {
        ...
        public void run2(){
            ...
            listUrlx.get(index).filePathName = listUrlx.get(index).filenamekey;
            ...
            try {
                ...
                if (rspCode == HttpURLConnection.HTTP_OK) {
                    ...
                    //}
                    if (listUrlx.get(index).type.equalsIgnoreCase("sse")) {
                        sendMsg_jsonSSE(3,listUrlx.get(index).filePathName,"",listUrlx.get(index).codekey,timeNow);
                    }else if (listUrlx.get(index).type.substring(0,4).equalsIgnoreCase("lhb_")) {
                        //sendMsg_jsonLhb(3,u.filePathName,ss,u.codekey,timeNow);
                    }else {
                        sendMsg_json1(3,listUrlx.get(index).filePathName,"",listUrlx.get(index).codekey,timeNow);
                    }
                    sendMessage(0,100,100,"","","");
        ...
        public void run() {
            ...
            try {
                ...
                if (rspCode == HttpURLConnection.HTTP_OK) {
                    ...
                    //}
                    if (listUrlx.get(index).type.equalsIgnoreCase("sse")) {
                        sendMsg_jsonSSE(3,listUrlx.get(index).filePathName,ss,listUrlx.get(index).codekey,timeNow);
                    }else if (listUrlx.get(index).type.substring(0,4).equalsIgnoreCase("lhb_")) {
                        //sendMsg_jsonLhb(3,u.filePathName,ss,u.codekey,timeNow);
                    }else {
                        sendMsg_json1(3,listUrlx.get(index).filePathName,ss,listUrlx.get(index).codekey,timeNow);
                    }
