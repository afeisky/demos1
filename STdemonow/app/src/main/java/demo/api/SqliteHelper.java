...
public class SqliteHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "asq3";
    private static final String DB_DIR = "/A";
    ...
    */
    ...
    private static final String SQL_CRESTE_BK = "CREATE TABLE  IF NOT EXISTS " + TBK.TABLE_NAME +
            ...
            TBK.COLUMN_CODE + " varchar(20), " +
            TBK.COLUMN_TIME + " varchar(20), " +
    ...
    private static final String SQL_CRESTE_BK_INDEX = "CREATE INDEX " + TBK.TABLE_NAME +"_index ON "+
            TBK.TABLE_NAME + " (" + TBK.COLUMN_CODE + " ASC," +TBK.COLUMN_TIME + " ASC);";
    ...
    private int createTable(SQLiteDatabase db){
        ...
        db.execSQL(SQL_CRESTE_BK_INDEX);
