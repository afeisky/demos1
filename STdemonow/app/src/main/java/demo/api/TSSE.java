...
public class TSSE {
    public static final String TABLE_NAME = "ssen";
    ...
    public static final String COLUMN_NOTE = "note";//"E111"
    ...
    public String time="";
    public String name="";
    public double begin=0.000;
    public double now=0.000;
    public double price=0.000;
    public double high=0.000;
    public double low=0.000;
    public double last=0.000;
    public double gap=0.000;
    public double wave=0.000;
