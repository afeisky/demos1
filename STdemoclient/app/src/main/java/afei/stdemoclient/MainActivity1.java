...
public class MainActivity1 extends FragmentActivity implements View.OnClickListener {
    ...
    //四个按钮  
    private ImageButton id_t1_tab1;
    private ImageButton id_t1_tab2;
    private ImageButton id_t1_tab3;
    private ImageButton id_t1_tab4;
    ...
    private void initViews() {  
        ...
        //初始化四个按钮
        id_t1_tab1 = (ImageButton) findViewById(R.id.id_tab1_page1);
        id_t1_tab2 = (ImageButton) findViewById(R.id.id_tab1_page2);
        id_t1_tab3 = (ImageButton) findViewById(R.id.id_tab1_page3);
        id_t1_tab4 = (ImageButton) findViewById(R.id.id_tab1_page4);
    ...
    private void initEvent() {
        ...
        //设置监听器  
        id_t1_tab1.setOnClickListener(this);
        id_t1_tab2.setOnClickListener(this);
        id_t1_tab3.setOnClickListener(this);
        id_t1_tab4.setOnClickListener(this);
    ...
    private void resetTab1FrameImg() {
        id_t1_tab1.setImageResource(R.mipmap.maintab_icon_1_normal);
        id_t1_tab2.setImageResource(R.mipmap.maintab_icon_2_normal);
        id_t1_tab3.setImageResource(R.mipmap.maintab_icon_3_normal);
        id_t1_tab4.setImageResource(R.mipmap.maintab_icon_4_normal);
    }
    ...
    private void selectTab1Fragment(int id){
        ...
        switch (id) {
            case 0:
                id_t1_tab1.setImageResource(R.mipmap.maintab_icon_1_selected);
                LogX.w(TAG,"fragmemt01");
                break;
            case 1:
                id_t1_tab2.setImageResource(R.mipmap.maintab_icon_2_selected);
                break;
            case 2:
                id_t1_tab3.setImageResource(R.mipmap.maintab_icon_3_selected);
                break;
            case 3:
                id_t1_tab4.setImageResource(R.mipmap.maintab_icon_4_selected);
                break;
            default:
                break;
        }
