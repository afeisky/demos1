...
//save:
    ...
    public int cmdSave(String from,String subject,String content,List<File> files,String folderName){
        ...
        log("cmdSave2() 1, "+ TimeX.getToday()+folderName);
        IMAPFolder folder=null;
        try {
            folder = (IMAPFolder) store.getFolder(folderName);
            folder.open(Folder.READ_WRITE);
    ...
    private static int saveNew(String from,String subject,String content,Session session,IMAPFolder folder){
        //save:
        try {
            MimeMessage mmessage = new MimeMessage(session);
            mmessage.setFrom(new InternetAddress(from));
    ...
    public static List<File> getFileList(String filepathname1){
        List<File> files=new ArrayList<File>();
        if (filepathname1!=null) {
            files.add(new File(filepathname1));
        }else if (filepathname1.length()>0) {
            files.add(new File(filepathname1));
        }
        return files;
    }
    public static List<File> getFileList(String filepathname1,String filepathname2,String filepathname3,String filepathname4,String filepathname5){
        List<File> files=new ArrayList<File>();
        if (filepathname1!=null) {
            files.add(new File(filepathname1));
        }else if (filepathname1.length()>0) {
        ...
        if (filepathname2!=null) {
            files.add(new File(filepathname2));
        }else if (filepathname2.length()>0) {
            files.add(new File(filepathname2));
        }
        if (filepathname3!=null) {
            files.add(new File(filepathname3));
        }else if (filepathname3.length()>0) {
            files.add(new File(filepathname3));
        }
        if (filepathname4!=null) {
            files.add(new File(filepathname4));
        }else if (filepathname4.length()>0) {
            files.add(new File(filepathname4));
        }
        if (filepathname5!=null) {
            files.add(new File(filepathname5));
        }else if (filepathname5.length()>0) {
            files.add(new File(filepathname5));
        }
